                                    ...
                                    <nav>
                                        <ul class="main-menu d-none d-lg-inline">
                                            <li class="menu-item-has-children">
                                                <RouterLink to="/">
                                                    <a href="index-2.html"><span class="mr-15">
                                                        ...
                                                        <div class="tab-pane show active" id="news-0" role="tabpanel">
                                                            <div class="row">
                                                                <div class="col-3 post-module-1">
                                                                    ...
                                                                    <div class="post-content media-body">
                                                                        <h6 class="post-title mb-10 text-limit-2-row">
                                                                            The litigants on the screen are not
                                                                            actors </h6>
                                                                        <div
                                                                ...
                                                                <div class="col-3 post-module-1">
                                                                    ...
                                                                    <div class="post-content media-body">
                                                                        <h6 class="post-title mb-10 text-limit-2-row">
                                                                            Not a bit of hesitation, you better
                                                                            think twice</h6>
                                                                        <div
                                                                ...
                                                                <div class="col-3 post-module-1">
                                                                    ...
                                                                    <div class="post-content media-body">
                                                                        <h6 class="post-title mb-10 text-limit-2-row">
                                                                            My entrance exam was on a book of
                                                                            matches </h6>
                                                                        <div
                                                                            class="entry-meta meta-1 font-x-small color-grey mt-10">
                                                                            <span class="post-on">25 April</span>
                                            ...
                                            <li>
                                                <RouterLink to="/contact"><a href=""><span class="mr-15">
                                                            <ion-icon name="mail-unread-outline"></ion-icon>
                                                        </span>Contact</a></RouterLink>
                                            </li>
                                        </ul>
