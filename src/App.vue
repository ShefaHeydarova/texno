...
import './assets/js/vendor/animated.headline.js'
import './assets/js/vendor/jquery.magnific-popup.js'
import './assets/js/vendor/jquery.ticker.js'
import './assets/js/vendor/jquery.vticker-min.js'
import './assets/js/vendor/jquery.scrollUp.min.js'
import './assets/js/vendor/jquery.nice-select.min.js'
import './assets/js/vendor/jquery.sticky.js'
import './assets/js/vendor/perfect-scrollbar.js'
import './assets/js/vendor/waypoints.min.js'
import './assets/js/vendor/jquery.counterup.min.js'
import './assets/js/vendor/jquery.theia.sticky.js'
                            ...
                            <ul class="list-post">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="post-content media-body">
                                            <h6 class="post-title mb-10 text-limit-2-row"><a
                                                    href="single.html">Vancouver woman finds pictures and videos of
                                                    herself online</a></h6>
                                            <div
                                ...
                                <li class="mb-30 wow fadeIn animated">
                                    <div class="d-flex">
                                        ...
                                        <div class="post-content media-body">
                                            <h6 class="post-title mb-10 text-limit-2-row"><a
                                                    href="single.html">Reflections from a Token Black Friend</a>
                                            </h6>
                                            <div
                                                class="entry-meta meta-1 font-x-small color-grey float-left text-uppercase">
                                ...
                                <li class="wow fadeIn animated">
                                    <div class="d-flex">
                                        ...
                                        <div class="post-content media-body">
                                            <h6 class="post-title mb-10 text-limit-2-row"><a
                                                    href="single.html">Blackface Minstrel Songs Don’t Belong in
                                                    Children’s Music Class</a></h6>
                                            <div
                                                class="entry-meta meta-1 font-x-small color-grey float-left text-uppercase">
