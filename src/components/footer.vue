                        ...
                        <div class="row pb-30">
                            ...
                            <div class="col">
                                <ul class="float-left mr-30 font-medium">
                                    ...
                                    <li class="cat-item cat-item-3"><a href="category.html">Medical Research</a>
                                    </li>
                                    <li class="cat-item cat-item-4"><a href="category.html">Children’s Health</a>
                                    </li>
                                    <li class="cat-item cat-item-5"><a href="category.html">Around the World</a>
                                    </li>
                            ...
                            <div class="col">
                                <ul class="float-left mr-30 font-medium">
                                    ...
                                    <li class="cat-item cat-item-5"><a href="category.html">Mortgage Calculator</a>
                                    </li>
                            ...
                            <div class="col d-none d-lg-block">
                                <ul class="float-left mr-30 font-medium">
                                    ...
                                    <li class="cat-item cat-item-4"><a href="category.html">Football: College</a>
                                    </li>
                                    <li class="cat-item cat-item-5"><a href="category.html">Football: N.F.L.</a>
                                    </li>
                            ...
                            <div class="row d-flex align-items-center justify-content-between">
                                <div class="col-12">
                                    <div class="footer-copy-right">
                                        <p class="font-small text-muted">© 2020, NewsViral | All rights reserved |
                                            Design by <a href="" target="_blank">AliThemes</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
